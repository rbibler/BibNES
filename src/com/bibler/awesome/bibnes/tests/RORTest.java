...
public class RORTest extends InstructionTest {
	...
	private final int ACCUMULATOR = 0x6A;
	private final int ZERO_PAGE = 0x66;
	private final int ZERO_PAGE_X = 0x76;
	private final int ABSOLUTE = 0x6E;
	private final int ABSOLUTE_X = 0x7E;
	...
	public void testAccumulatorWithCarry() {
		...
		runNCycles(2);
		int statusRegister = getStatusRegister();
		assertEquals(0xD5, getAccumulator());
		assertEquals(0, statusRegister & 1);
	}
